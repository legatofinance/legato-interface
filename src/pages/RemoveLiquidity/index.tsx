      ...
      <>
        <RowBetween>
          <Text color={theme.text2} fontWeight={500} fontSize={16}>
            <Trans>
              LDOGE {currencyA?.symbol}/{currencyB?.symbol} Burned
            </Trans>
          </Text>
          <RowFixed>
                  ...
                  <AutoColumn gap="10px">
                    ...
                    {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                      <RowBetween style={{ justifyContent: 'flex-end' }}>
                        {oneCurrencyIsETH ? (
                          <StyledInternalLink
                            to={`/remove/${currencyA?.isNative ? WETH9_EXTENDED[chainId].address : currencyIdA}/${
                          ...
                          <StyledInternalLink
                            to={`/remove/${currencyA?.equals(WETH9_EXTENDED[chainId]) ? 'BNB' : currencyIdA}/${
                              currencyB?.equals(WETH9_EXTENDED[chainId]) ? 'BNB' : currencyIdB
                            }`}
                          >
                            Receive BNB
                          </StyledInternalLink>
