...
import { LDOGE_ADDRESS } from '../../constants/addresses'
...
const BAD_RECIPIENT_ADDRESSES: { [address: string]: true } = {
  '0xBCfCcbde45cE874adCB698cC183deBcF17952812': true, // v2 factory
  '0xf164fC0Ec4E93095b804a4795bBe1e041497b92a': true, // v2 router 01
  '0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F': true, // v2 router 02
}
...
export function useDerivedSwapInfo(): {
  ...
  const toggledTrade = (isExactIn ? bestV2TradeExactIn : bestV2TradeExactOut) ?? undefined
...
export function queryParametersToSwapState(parsedQs: ParsedQs): SwapState {
  ...
  if (inputCurrency === '' && outputCurrency === '') {
    // default to BNB input
    inputCurrency = 'BNB'
    outputCurrency = LDOGE_ADDRESS[SupportedChainId.MAINNET]
