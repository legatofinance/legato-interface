        ...
        <ContentWrapper gap="lg">
            ...
            <CardSection gap="md">
              <RowBetween>
                <TYPE.white fontWeight={500}>
                  <Trans>Claim LDOGE</Trans>
                </TYPE.white>
                <CloseIcon onClick={toggleClaimModal} style={{ zIndex: 99 }} color="white" />
              </RowBetween>
              <TYPE.white fontWeight={700} fontSize={36}>
                <Trans>{unclaimedAmount?.toFixed(0, { groupSeparator: ',' } ?? '-')} LDOGE</Trans>
              </TYPE.white>
            </CardSection>
            <Break />
            <CardSection gap="sm">
              {userClaimData?.flags?.isSOCKS && (
                <RowBetween>
                  ...
                  <TYPE.subHeader color="white">
                    <Trans>{SOCKS_AMOUNT} LDOGE</Trans>
                  </TYPE.subHeader>
                </RowBetween>
              )}
          ...
          <AutoColumn gap="md" style={{ padding: '1rem', paddingTop: '0' }} justify="center">
            <TYPE.subHeader fontWeight={500}>
              <Trans>
                As a member of the LamboDoge community you may claim LDOGE to be used for voting and governance.
                <br />
                <br />
                <ExternalLink href="https://lambodoge.org/">Read more about LDOGE</ExternalLink>
              </Trans>
            </TYPE.subHeader>
            <ButtonPrimary
        ...
        <ConfirmOrLoadingWrapper activeBG={true}>
          ...
          <ConfirmedIcon>
            {!claimConfirmed ? (
              ...
              <UniTokenAnimated width="72px" src={tokenLogo} alt="LDOGE" />
            )}
          </ConfirmedIcon>
