        ...
        <ContentWrapper gap="lg">
          ...
          <AutoColumn gap="md" style={{ padding: '1rem', paddingTop: '0' }} justify="center">
            <TYPE.subHeader fontWeight={500}>
              <Trans>
                Enter an address to trigger a LDOGE claim. If the address has any claimable LDOGE it will be sent to
                them on submission.
              </Trans>
            </TYPE.subHeader>
        ...
        <ConfirmOrLoadingWrapper activeBG={true}>
          ...
          <ConfirmedIcon>
            {!claimConfirmed ? (
              ...
              <UniTokenAnimated width="72px" src={tokenLogo} alt="LDOGE logo" />
            )}
          </ConfirmedIcon>
